...
function setRecentlyViewedProduct() {
  ...
  const pdpData = {
    productTitle: productDataElement.getAttribute('data-product-title'),
    productImg: productDataElement.getAttribute('data-product-img'),
    productPrice: productDataElement.getAttribute('data-product-price'), // Current price (on sale)
    productRegularPrice: productDataElement.getAttribute('productRegularPrice'), // Regular price
    productOriginalPrice: productDataElement.getAttribute('data-product-original-price'), // Original price (if applicable)
    productUrl: productDataElement.getAttribute('data-product-url')
  };
  let recentlyViewed = JSON.parse(localStorage.getItem('recently_viewed')) || [];
  recentlyViewed = recentlyViewed.filter(product => product.productUrl !== pdpData.productUrl);
...
function displayRecentlyViewedProducts() {
  const recentlyViewedContainer = document.getElementById('recently-viewed-products-list'); // Ensure this matches your HTML
  ...
  recentlyViewed.forEach(product => {
    ...
    productItem.innerHTML = `
      <div class="card-wrapper product-card-wrapper underline-links-hover" bis_skin_checked="1">
        <div class="card card--standard card--media " style="--ratio-percent: 100%;" bis_skin_checked="1">
          <div class="card__inner color-scheme-1 gradient ratio" style="--ratio-percent: 100%;" bis_skin_checked="1">
            <div class="card__media" bis_skin_checked="1">
              <div class="media media--transparent media--hover-effect" bis_skin_checked="1">
                <img src="${product.productImg}" 
                     alt="${product.productTitle}" loading="lazy" 
            ...
            <div class="card__content">
              <div class="card__information">
                <h3 class="card__heading">
                  <a href="${product.productUrl}" class="full-unstyled-link">${product.productTitle}</a>
                </h3>
              </div>
            </div>
          </div>
                    ...
                    ${product.productRegularPrice ? `
                      <div class="price__regular">
                        ...
                        <span class="price-item price-item--regular">
                          <span class="money">${product.productRegularPrice}</span>
                        </span>
                      </div>
                    ` : ''}
                    <div class="price__sale">
                      ...
                      <span>
                        <s class="price-item price-item--regular">
                          <span class="money">${product.productOriginalPrice}</span>
                        </s>
                      </span>
                      <span class="visually-hidden visually-hidden--inline">Prezzo scontato</span>
                      <span class="price-item price-item--sale price-item--last">
                        <span class="money">${product.productPrice}</span>
                      </span>
                    </div>
    ...
    recentlyViewedContainer.appendChild(productItem);
  });
}
document.addEventListener('DOMContentLoaded', function () {
